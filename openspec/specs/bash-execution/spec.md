...
Provides secure shell command execution capabilities for the agent, allowing execution of bash commands with controlled timeouts, environment variables, and output handling.
