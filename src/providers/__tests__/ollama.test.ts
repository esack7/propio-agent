...
describe('OllamaProvider', () => {
  ...
  describe('Message type translation', () => {
    ...
    it('should preserve all roles in translation', () => {
      const roles: ChatMessage['role'][] = ['user', 'assistant', 'system', 'tool'];
      roles.forEach(role => {
        const chatMsg: ChatMessage = {
          role,
          content: 'Test'
    ...
    it('should translate Ollama Message to ChatMessage', () => {
      ...
      const translated = (provider as any).ollamaMessageToChatMessage(ollamaMsg);
  ...
  describe('Tool definition translation', () => {
    ...
    it('should preserve complex parameters in translation', () => {
      ...
      const translated = (provider as any).chatToolToOllamaTool(chatTool);
      expect(translated.function.parameters.properties.items.type).toBe('array');
    });
  });
  ...
  describe('Non-streaming chat', () => {
    ...
    it('should call ollama.chat with stream false', async () => {
      mockChatMethod.mockResolvedValue({
        message: {
          role: 'assistant',
          content: 'Response'
        }
