...
Tool policy records include a fingerprint of the reviewed arguments, matched by the dispatch record; full capture separately retains the arguments as private material. Cancellation before authorization or during an approval callback is recorded as `cancelled`, distinct from denial and callback failure. No cancelled or denied tool is dispatched.
